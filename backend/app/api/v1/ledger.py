...
# ---------------- 库存预警 ----------------
@router.get("/stock-alerts", name="list_stock_alerts")
...
@router.post("/stock-alerts/scan", name="scan_stock_alerts")
...
@router.get("/stock-alerts/{alert_id}", name="get_stock_alert")
...
@router.post("/stock-alerts/{alert_id}/ack", name="ack_stock_alert")
...
@router.post("/stock-alerts/{alert_id}/resolve", name="resolve_stock_alert")
...
@router.post("/stock-alerts/{alert_id}/ignore", name="ignore_stock_alert")
...
# ---------------- 每日结存快照 ----------------
@router.get("/inventory-snapshots", name="list_inventory_snapshots")
...
@router.post("/inventory-snapshots/generate", name="generate_inventory_snapshots")
...
# ---------------- 供货价 ----------------
@router.get("/material-supplier-prices", name="list_material_supplier_prices")
...
@router.post("/material-supplier-prices", status_code=201, name="create_material_supplier_price")
...
@router.get("/material-supplier-prices/{price_id}", name="get_material_supplier_price")
...
@router.put("/material-supplier-prices/{price_id}", name="update_material_supplier_price")
